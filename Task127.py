...
# Во время соревнования необходимо ввести текст из s символов. Первый участник набирает один символ 
# за v1 миллисекунд и имеет пинг t1 миллисекунд. Второй участник набирает один символ за v2 миллисекунд и 
# имеет пинг t2 миллисекунд.
...
count, V1, V2, t1, t2 = map(int, input().split())
time_1 = 2 * t1 + (count * V1)
time_2 = 2 * t2 + (count * V2)
if time_1 < time_2:
    print('First')
else:
    if time_1 > time_2:
