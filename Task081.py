...
# Все знаки препинания, пробелы, регистр букв важны. Также обратите внимание, что в этом месте «1920 x 1080»
# стоит английская буква «x»
...
Общее количество пикселей = {width * heigth}""")