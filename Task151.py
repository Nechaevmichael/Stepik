...
# Начиная с числа n, умножайте имеющееся число на его первую цифру, пока у получившегося числа 
# первая цифра не станет равной 1, либо пока оно не превысит миллиарда. В качестве ответа выведите результат
# Sample Input:
# 8
# Sample Output:
# 1152
...
first = int(str(n)[0])
while first != 1 and n <= 1000000000:
    n *= first
    first = int(str(n)[0])
print(n)