...
# environ представляет собой по сути словарь переменных окружения, и нам интересно взглянуть на значение, 
# которое хранится под ключом 'HOME', его необходимо вывести на экран
